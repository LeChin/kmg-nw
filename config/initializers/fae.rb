Fae.setup do |config|
  ...
  config.devise_secret_key = '940912b2acdc109626e3d66378bd9e52fff0b6cc0753f51a1a759f483196a67b88cee9e6352e8fc9035f5305be615a367b8bdbb976df444c429a7256a584cfe1'
  ...
  config.dashboard_exclusions = %w( Media ClassType Schedule Day Pricing DaySchedule FreeTrialRequest )
